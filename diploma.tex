...
\TODO{Intro.}
	...
	algoritem sestopi, če ne najdemo ustreznega stolpca. V vrstici 6 preverimo, če v trenutni vrstici obstaja še neobiskan stolpec (zaenkrat ignorirajmo del v 	
	...
	katerem od prejšnjih korakov ($F_j=0$; pogoj za injektivno preslikavo). Sama izbira stolpca poteka v vrsticah 7--9, ko vrednost $k$ postavimo na izbrani
	stolpec.
	...
	v naslednji ponovitvi zanke preverili, če je v zadnji vrstici še kakšen primeren stolpec. Vrstice 17--20 skrbijo za sestopanje, ki se izvede, če v trenutni 
	vrstici ni nobenega primernega stolpca več. V vrstici 18 sprostimo zadnji izbrani stolpec ($F_k \gets 0$) in znižamo globino. Nato v vrstici 20 obnovimo
