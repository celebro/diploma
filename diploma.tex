...
\chapter{Definicije}
	...
	\section{Graf}
	Graf $G = (V, E)$ je definiran z množico vozlišč $V$ (ang.~vertices) in množico povezav $E$ (ang.~edges). Povezava je par vozlišč 
	...
	Graf $G' = (V', E')$ je podgraf danega grafa $G = (V, E)$, če velja $V' \subseteq V \wedge E' \subseteq E$. 
	Graf $G' = (V', E')$ je induciran podgraf danega grafa $G = (V, E)$, če vsebuje vse povezave, katerih vozlišča so v $V'$, oz. če velja
	$E' = E \cap (V' \times V')$.

	Grafa $G_p = (V_p, E_p)$ in $G_t = (V_t, E_t)$ sta izomorfna, če obstaja bijektivna preslikava $f: V_p \to V_t$ da velja: 
