...
\end{algorithm}
	...
	Podani algoritem je v \refalg{alg:ullmann1} in \refalg{alg:ullmann1} že vključen, klic funkcije $refine$ je v oglatih oklepajih, ki smo jih predhodno
	ignorirali.
...
%\end{spacing}
	...
	$O(n_p! n_p n_t d_{max})$. V eni ponovitvi zanke je funkcija $refine$ najzahtevnejša, število ponovitev pa je reda $n_p!$.
