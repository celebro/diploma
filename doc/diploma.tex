...
\chapter{Uvod}
Notes: Splošni algoritmi, brez predpostavk topologiji grafov. Iskanje vseh podgrafov
...
\chapter{Subsee}
	Notes: učinkovit za iskanje vseh podrafov. Samo za povezane grafe? Uporablja bisekcijo. Posebna predstavitev grafa, da algoritem najprej preveri bolj
	goste dele -> hitro iskanje negativov. Posebno uporabno kjer je ciljni graf mnogo večji od vzorčnega (uporabno za web in socialna omrežja, geni,
	proteini).
	...
	Algoritem Subsee med delovanjem razdeli graf na dve enako veliki množici (particiji) - naredi bisekcijo. Algoritem deluje hitreje, če je bisekcija 
	...
	pomembno število elementov v particijah. Problem minimalne bisekcije je NP-poln, vendar pravilnost algoritma Subsee ni odvisna od natančnosti
