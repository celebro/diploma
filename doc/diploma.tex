...
\end{algorithm}
	...
	vzamemo vedno samo najmanjši element, kar predstavlja oznaka $min$ v enačbah. Na tak način se tudi izognemo generiranju enakih stanj. Omenimo še,
	da v sami implementaciji algoritma ni potrebe po eksplicitnem generiranju $P(s)$, ampak se pare dobi implicitno iz uporabljenih podatkovnih struktur.
