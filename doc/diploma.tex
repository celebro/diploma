...
\chapter{Eksperimentalna primerjava algoritmov}
	...
	% štetje vseh podgrafnih izomorfizmov
	% database link and description
	% usmerjeni, induciran podgrafni izomorfizem
	...
	\href{http://mivia.unisa.it/datasets/graph-database/browse-db/}{http://mivia.unisa.it/\-datasets/\-graph-database/browse-db/}. Celotna baza vsebuje 	
	$72.800$ parov grafov (po en vzorčni in
	...
	podani v grafični obliki na slikah~\ref{pic_res_si2}--\ref{pic_res2_si6}. Grafi na slikah~\ref{pic_res_si2}--\ref{pic_res_si6} predstavljajo število rešenih
	...
	Grafi na slikah~\ref{pic_res2_si2}--\ref{pic_res2_si6} predstavljajo povprečen čas izvajanja algoritma v odvisnosti od velikosti problema, kjer so
	...
	gre v osnovi za isti algoritem. S povečevanjem števila vozlišč je izboljšani Ullmannov algoritem še vedno boljši od VF2, izboljšani VF2 pa se najprej
	...
	algoritem hitrejši samo pri grafih z 20 vozlišči. Kot je bilo že omenjeno, smo izvajanje posameznega testa omejili na 60 sekund. V računanju 
	...
	To se na grafih vidi kot negativen drugi odvod krivulje za osnovni algoritem VF2, ker je navzgor omejena z vrednostjo 60 sekund.
	

	\begin{table}
	\small
	\begin{tabular}{|c|c|c|c|c|c|c|c|c|}\hline
	Grafi	& \multicolumn{3}{|c|}{\% rešenih primerov}	& \multicolumn{3}{|c|}{celoten čas [min]}
	& \multicolumn{2}{|c|}{faktor pohitritve (VF2)} \\\hline
	...
	si6\_r01 		& 99,2	& 100,0	& 81,5	& 65,8	& 3,5		& 220,4	& 3		& 62		\\\specialrule{.1em}{.05em}{.05em}
	skupno 		& 99,14	& 99,98	& 87,88	& 270	& 42		& 1393	& 5		& 35		\\\hline
	\end{tabular}
	\end{table}
