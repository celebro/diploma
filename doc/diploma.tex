...
\chapter{Algoritem VF2}
	...
	$G_t(s) \subseteq G_t$, ki sta si izomorfna. Podgrafa vsebujeta tista vozlišča, ki so tudi v $M(s)$. Uporabljali bomo oznaki $M_p(s)$ in $M_t(s)$,
	...
	Psevdokoda okvirnega poteka algoritma je podana v~\refalg{alg:vf2}. Algoritem je rekurziven. Ob prvem klicu je $M(s_0)$ prazna. V vrstici 2 preverimo,
...
\end{algorithm}
	...
	\begin{figure}
	\begin{center}
	\includegraphics[width=6cm]{img/graph_t_in_out.png}
	\end{center}
	\caption{}
	\label{pic_t_in_out}
	\end{figure}
